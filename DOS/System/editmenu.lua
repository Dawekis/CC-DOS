    ...
    if item.text ~= "1.lua" then
        ...
        cat.Basalt.Button_Text(sub[1],11,1,"Add",colors.red,colors.black,function ()
            ...
            for i in io.lines("DOS/Menu/Main/"..item.text) do
                ...
                tempmenu:write('cat.Text(6,6,colors.black,colors.lightBlue,"Use the left mouse button to drag the icon")\n')
                tempmenu:write('cat.Text(4,7,colors.black,colors.lightBlue,"to the you want position")\n')
                tempmenu:write('cat.Text(6,8,colors.black,colors.lightBlue,"After dragging with the left mouse button,")\n')
                tempmenu:write('cat.Text(4,9,colors.black,colors.lightBlue,"the icon will automatically appear")\n')
                tempmenu:write('cat.Text(6,11,colors.black,colors.lightBlue,"Drag with the right mouse button to")\n')
                tempmenu:write('cat.Text(4,12,colors.black,colors.lightBlue,"end selecting icon position")\n')
                else
                    tempmenu:write(i.."\n")
                end
            end
        ...
        cat.Basalt.Button_Text(sub[1],15,1,"Rm",colors.red,colors.black,function ()
            local tip = miniframe:addMovableFrame()
            ...
            cat.Basalt.Button_Text(tip,6,3,"OK",colors.red,colors.black,function ()
                ...
                shell.run("copy",".../DOS/System/luaconfig.txt",".../DOS/Menu/"..menulist:getItemIndex().."/lua_1.txt")
                tip:remove()
            end)
        end)
        ...
        cat.Basalt.Button_Text(sub[2],15,1,"Rm",colors.red,colors.black,function ()
            ...
            cat.Basalt.Button_Text(tip,6,3,"OK",colors.red,colors.black,function ()
                ...
                shell.run("copy",".../DOS/System/luaconfig.txt",".../DOS/Menu/"..menulist:getItemIndex().."/lua_2.txt")
                tip:remove()
            end)
        end)
        ...
        cat.Basalt.Button_Text(sub[3],15,1,"Rm",colors.red,colors.black,function ()
            ...
            cat.Basalt.Button_Text(tip,6,3,"OK",colors.red,colors.black,function ()
                ...
                shell.run("copy",".../DOS/System/luaconfig.txt",".../DOS/Menu/"..menulist:getItemIndex().."/lua_3.txt")
                tip:remove()
            end)
        end)
        ...
        cat.Basalt.Button_Text(sub[4],15,1,"Rm",colors.red,colors.black,function ()
            ...
            cat.Basalt.Button_Text(tip,6,3,"OK",colors.red,colors.black,function ()
                ...
                shell.run("copy",".../DOS/System/luaconfig.txt",".../DOS/Menu/"..menulist:getItemIndex().."/lua_4.txt")
                tip:remove()
            end)
        end)
        ...
        cat.Basalt.Button_Text(sub[5],15,1,"Rm",colors.red,colors.black,function ()
            ...
            cat.Basalt.Button_Text(tip,6,3,"OK",colors.red,colors.black,function ()
                ...
                shell.run("copy",".../DOS/System/luaconfig.txt",".../DOS/Menu/"..menulist:getItemIndex().."/lua_5.txt")
                tip:remove()
            end)
        end)
        ...
        cat.Basalt.Button_Text(sub[6],15,1,"Rm",colors.red,colors.black,function ()
            ...
            cat.Basalt.Button_Text(tip,6,3,"OK",colors.red,colors.black,function ()
                ...
                shell.run("copy",".../DOS/System/luaconfig.txt",".../DOS/Menu/"..menulist:getItemIndex().."/lua_6.txt")
                tip:remove()
            end)
        end)
        ...
        cat.Basalt.Button_Text(sub[7],15,1,"Rm",colors.red,colors.black,function ()
            ...
            cat.Basalt.Button_Text(tip,6,3,"OK",colors.red,colors.black,function ()
                ...
                shell.run("copy",".../DOS/System/luaconfig.txt",".../DOS/Menu/"..menulist:getItemIndex().."/lua_7.txt")
                tip:remove()
            end)
        end)
        ...
        cat.Basalt.Button_Text(sub[8],15,1,"Rm",colors.red,colors.black,function ()
            ...
            cat.Basalt.Button_Text(tip,6,3,"OK",colors.red,colors.black,function ()
                ...
                shell.run("copy",".../DOS/System/luaconfig.txt",".../DOS/Menu/"..menulist:getItemIndex().."/lua_8.txt")
                tip:remove()
            end)
        end)
        local y = 3
